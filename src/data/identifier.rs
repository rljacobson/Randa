...
impl Identifier {
    ...
    pub fn compile(&self, heap: &mut Heap) -> Value {
        ...
        let mut id_head = heap.strcons_ref(Value::from(string_ref), who);
        id_head = heap.cons_ref(id_head, self.datatype);
        ...
        let id_ref: Value = heap.put_ref(Tag::Id, id_head, value);
    ...
    pub fn get(reference: Value, heap: &Heap) -> Result<Identifier, ()> {
        ...
        let name: String = heap.resolve_string(strcons_cell.head.into())?;
...
impl IdentifierDefinition {
    ...
    pub fn get(reference: Value, heap: &Heap) -> Result<IdentifierDefinition, ()> {
        ...
        if who_cell.tag == Tag::Cons {
            ...
            let source: String = heap.resolve_string(aka_cell.head.into())?;
    ...
    fn get_here_info(reference: Value, heap: &Heap) -> Result<(String, LineNumber), ()> {
        ...
        let script_file = heap.resolve_string(here_info_cell.head.into())?;
    ...
    pub fn compile(&self, heap: &mut Heap) -> Value {
        ...
        match self {
            ...
            IdentifierValue::Typed {
                ...
                let value_head = heap.cons_ref(Value::Data(*arity), *show_function);
                let value_tail = value_type.compile(heap);
                heap.cons_ref(value_head, value_tail)
            }
        ...
        if reference == Combinator::Undef.into() {
            ...
            if let Value::Reference(idx) = reference {
                ...
                if outer_cons_cell.tag == Tag::Cons {
                    ...
                    let arity: isize = inner_cons_cell.head;
...
impl IdentifierValueType {
    pub fn compile(&self, heap: &mut Heap) -> Value {
        ...
        match self {
            ...
            IdentifierValueType::Free => heap.cons_ref(Value::Data(4), Combinator::Nil.into()),
        } // end match on self
    }
